...
export default function CommercialPage() {
  ...
  const handleCommercialSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    ...
    fetch('/enquire-now-api.php', {
      ...
      body: JSON.stringify({ name: nameVal, phone: phoneVal, email: emailVal, project: selectedProject || 'RRL Commercial' }),
    }).catch(console.error)
