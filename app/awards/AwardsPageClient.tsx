...
import { Trophy, Award, Star, Medal, Newspaper, Globe, Quote, Users, Building, Crown } from "lucide-react"
import { motion } from "framer-motion"
...
function LegacyAchievements() {
  const awardsData = [
    {
      year: "2026",
      title: "Times Business Awards by The Times of India",
      category: "Emerging Developer of the Year - Residential",
      icon: Crown, 
      color: "bg-gray-700",
    },
    {
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 md:mb-20 grid items-center gap-12 md:grid-cols-2 md:gap-16">
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="relative rounded-3xl bg-black/30 border border-gold-800 p-4 sm:p-6 shadow-2xl">
              <Image
                src="https://ik.imagekit.io/j0xzq9pns/RRL%20Awards/rrl-award.jpeg?updatedAt=1779452566010"
                // src=""
                alt="Times Real Estate Award"
                width={600}
                height={400}
                className="h-auto w-full rounded-2xl shadow-lg"
              />
