...
//     try {
//       const res = await fetch("/api/send-emi-request", {
//         method: "POST",
...
//             <button
//               onClick={() => setActiveTab("residential")}
//               className={`flex items-center space-x-2 rounded-full px-6 py-3 font-semibold transition-all duration-300 ${activeTab === "residential" ? "bg-gold-500 text-black shadow-md" : "text-gray-400 hover:text-white"
//                 }`}
//             >
//               <Home className="h-4 w-4" />
//               <span>Residential</span>
...
//             <button
//               onClick={() => setActiveTab("commercial")}
//               className={`flex items-center space-x-2 rounded-full px-6 py-3 font-semibold transition-all duration-300 ${activeTab === "commercial" ? "bg-gold-500 text-black shadow-md" : "text-gray-400 hover:text-white"
//                 }`}
//             >
//               <Building2 className="h-4 w-4" />
//               <span>Commercial</span>
...
//                     <div className="absolute left-4 top-4">
//                       <div
//                         className={`rounded-full px-3 py-1 text-xs font-semibold ${property.status === "Award Winner" ? "bg-gold-500 text-black" :
//                             property.status === "Ready to Move" || property.status === "Operational" ? "bg-emerald-600 text-white" : "bg-blue-600 text-white"
//                           }`}
//                       >
//                         {property.status}
