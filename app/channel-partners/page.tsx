...
//       <section className="relative py-16 sm:py-24 bg-light-black min-h-[90vh] flex items-center">
//         <div className="absolute inset-0 bg-grid-white/[0.05]"></div>
...
//               </motion.h1>
//               <motion.p
//                 className="mx-auto lg:mx-0 mt-6 max-w-2xl text-lg leading-8 text-gray-400"
//                 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }}
//               >
//                 Collaborate, connect, and unlock new opportunities in real estate. Let's build the future together. 
//               </motion.p>
...
//             >
//               <Card className="bg-gray-900/80 border-gold-800 p-6 sm:p-8 backdrop-blur-sm">
//                 <CardHeader className="text-center">
//                   <CardTitle className="text-2xl sm:text-3xl font-playfair text-gold-400">Get Started</CardTitle>
//                   <p className="text-gray-400 mt-2 text-sm sm:text-base">Register with us by filling out the form below.</p>
//                 </CardHeader>
//                 <CardContent>
//                   <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6 mt-2">
//                     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                       <Input type="text" name="name" placeholder="Your Name" value={formData.name} onChange={(e) => setFormData({...formData, name: e.target.value})} required className="h-10 sm:h-12 bg-black/30 border-gold-700 focus:border-gold-500" />
//                       <Input type="text" name="company" placeholder="Company Name" value={formData.company} onChange={(e) => setFormData({...formData, company: e.target.value})} required className="h-10 sm:h-12 bg-black/30 border-gold-700 focus:border-gold-500" />
//                     </div>
//                     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                       <Input type="email" name="email" placeholder="Email Address" value={formData.email} onChange={(e) => setFormData({...formData, email: e.target.value})} required className="h-10 sm:h-12 bg-black/30 border-gold-700 focus:border-gold-500" />
//                       <Input type="tel" name="phone" placeholder="Phone Number" value={formData.phone} onChange={(e) => setFormData({...formData, phone: e.target.value})} required className="h-10 sm:h-12 bg-black/30 border-gold-700 focus:border-gold-500" />
//                     </div>
//                     <div>
//                       <Textarea placeholder="Tell us about your company (Optional)" name="message" value={formData.message} onChange={(e) => setFormData({...formData, message: e.target.value})} className="bg-black/30 border-gold-700 focus:border-gold-500 min-h-[80px] sm:min-h-[100px]" />
//                     </div>
//                     <Button type="submit" size="lg" className="w-full bg-gold-500 hover:bg-gold-600 text-black font-semibold">
//                       Register Now
//                     </Button>
...
import { useState } from "react"
import { motion } from "framer-motion"
import { Handshake, UserCheck, Star, Zap, BarChart, Calendar, CheckCircle2 } from "lucide-react"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { Button } from "@/components/ui/button"
import { Input } from "@/components/ui/input"
import { Textarea } from "@/components/ui/textarea"
...
export default function ChannelPartnersPage() {
    // 2. Formspree Hook Configuration
    // REPLACE "YOUR_FORMSPREE_FORM_ID" with your actual Form ID
    const [state, handleSubmit] = useForm("xdanyywy");

    // Kept your original state and logic exactly as requested
    const [formData, setFormData] = useState({ name: "", company: "", email: "", phone: "", message: "" });
    
    // Note: The manual handleSubmit is replaced by Formspree's handler in the form tag below,
    // but the state management (formData) is kept for the input values.
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <Card className="bg-gray-900/80 border-gold-800 p-6 sm:p-8 backdrop-blur-sm">
                ...
                <CardContent>
                  {/* Conditional Render: Show Success Message OR Form */}
                  {state.succeeded ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6 mt-2">
                        ...
                        <Input 
                            ...
                            required 
                            className="h-10 sm:h-12 bg-black/30 border-gold-700 focus:border-gold-500" 
                        />
                        <Input 
                            type="text" 
                        ...
                        <Textarea 
                            ...
                            className="bg-black/30 border-gold-700 focus:border-gold-500 min-h-[80px] sm:min-h-[100px]" 
                        />
                        </div>
                        <Button 
                            type="submit" 
