...
// {
// icon: Users,
// label: "Families & Lives Impacted",
// value: "10K+",
// },
// ]

// const galleryImages = [
// "[https://images.unsplash.com/photo-1529156069898-49953e39b3ac?q=80&w=1200&auto=format&fit=crop](https://images.unsplash.com/photo-1529156069898-49953e39b3ac?q=80&w=1200&auto=format&fit=crop)",
// "[https://images.unsplash.com/photo-1517048676732-d65bc937f952?q=80&w=1200&auto=format&fit=crop](https://images.unsplash.com/photo-1517048676732-d65bc937f952?q=80&w=1200&auto=format&fit=crop)",
// "[https://images.unsplash.com/photo-1441974231531-c6227db76b6e?q=80&w=1200&auto=format&fit=crop](https://images.unsplash.com/photo-1441974231531-c6227db76b6e?q=80&w=1200&auto=format&fit=crop)",
// "[https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=1200&auto=format&fit=crop](https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=1200&auto=format&fit=crop)",
// "[https://images.unsplash.com/photo-1524492412937-b28074a5d7da?q=80&w=1200&auto=format&fit=crop](https://images.unsplash.com/photo-1524492412937-b28074a5d7da?q=80&w=1200&auto=format&fit=crop)",
// "[https://images.unsplash.com/photo-1497366754035-f200968a6e72?q=80&w=1200&auto=format&fit=crop](https://images.unsplash.com/photo-1497366754035-f200968a6e72?q=80&w=1200&auto=format&fit=crop)",
// ]

// return ( <div className="bg-black min-h-screen text-white overflow-hidden">

// ```
//   {/* HERO SECTION */}
//   <section className="relative h-[85vh] flex items-center justify-center overflow-hidden border-b border-yellow-500/20">
...
//         animate={{ opacity: 1, scale: 1 }}
//         transition={{ duration: 0.8 }}
//         className="inline-flex items-center gap-2 border border-yellow-500/40 bg-yellow-500/10 backdrop-blur-xl px-6 py-3 rounded-full mb-8"
//       >
//         <Heart className="w-4 h-4 text-yellow-400" />
//         <span className="text-yellow-300 uppercase tracking-[0.3em] text-xs font-semibold">
//           Community First
//         </span>
//       </motion.div>
...
//       >
//         Building
//         <span className="text-yellow-400"> Communities</span>,
//         <br />
//         Not Just Homes.
//       </motion.h1>
...
//         animate={{ opacity: 1, y: 0 }}
//         transition={{ duration: 0.8, delay: 0.4 }}
//         className="text-lg md:text-2xl text-gray-300 leading-relaxed max-w-4xl mx-auto"
//       >
//         At RRL Builders & Developers, we believe true development goes beyond architecture.
//         From supporting local communities and preserving cultural heritage to promoting
//         sustainability and responsible urban growth, our CSR initiatives are focused on
//         creating long-lasting impact across Bangalore and the communities we serve.
//       </motion.p>
//     </motion.div>
//   </section>
...
//           Creating Meaningful
//           <span className="text-yellow-400"> Social Impact</span>
//         </h2>

//         <p className="text-xl text-gray-400 leading-relaxed">
//           Recognized as trusted builders in Bangalore, RRL Builders & Developers actively contributes
//           to community welfare, sustainability, and cultural preservation through impactful CSR initiatives.
//         </p>
//       </div>

//       <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">

//         <div className="bg-white/[0.03] backdrop-blur-xl p-10 rounded-3xl border border-yellow-500/10 hover:border-yellow-500/40 hover:-translate-y-2 transition-all duration-500 shadow-[0_0_40px_rgba(255,215,0,0.05)]">
//           <div className="w-16 h-16 rounded-2xl bg-yellow-500/10 border border-yellow-500/20 flex items-center justify-center mb-8">
...
//           <p className="text-gray-400 leading-relaxed text-lg">
//             We organize community engagement programs, awareness initiatives,
//             and support local welfare activities that strengthen social harmony
...
//           <p className="text-gray-400 leading-relaxed text-lg">
//             We proudly support temple renovations, local traditions,
//             and cultural events that preserve the identity and heritage
//             of our communities.
//           </p>
//         </div>
...
//           <p className="text-gray-400 leading-relaxed text-lg">
//             Through green initiatives, tree plantation drives,
//             and eco-conscious infrastructure, we work toward building
...
//           <h2 className="text-4xl md:text-6xl font-bold mt-5 mb-8 leading-tight">
//             Building Responsible
//             <span className="text-yellow-400"> Urban Communities</span>
//           </h2>

//           <p className="text-gray-400 text-lg leading-relaxed mb-6">
//             As one of Bangalore’s rapidly growing real estate developers,
//             RRL Builders & Developers believes every project should positively
//             contribute to the people and environment around it.
//           </p>

//           <p className="text-gray-400 text-lg leading-relaxed mb-8">
//             Our CSR vision focuses on sustainable infrastructure,
//             community welfare, cultural preservation, environmental awareness,
//             and creating meaningful opportunities for future generations.
//           </p>

//           <div className="grid grid-cols-2 gap-6 mt-10">
//             <div className="border border-yellow-500/20 rounded-3xl p-6 bg-neutral-900/40 backdrop-blur-xl">
...
//             <div className="border border-yellow-500/20 rounded-3xl p-6 bg-neutral-900/40 backdrop-blur-xl">
//               <h4 className="text-4xl font-bold text-yellow-400 mb-2">150+</h4>
//               <p className="text-gray-400 text-sm uppercase tracking-wider">
//                 Employees & Workforce
//               </p>
//             </div>
...
//         <div className="relative h-[600px] rounded-[40px] overflow-hidden border border-yellow-500/20 shadow-[0_0_50px_rgba(255,215,0,0.08)]">
//           <Image
...
//   <section className="py-24 bg-neutral-950 border-y border-yellow-500/10">
//     <div className="container mx-auto px-4 max-w-7xl">

//       <div className="bg-white/[0.03] backdrop-blur-xl rounded-[40px] p-10 md:p-16 border border-yellow-500/10 shadow-[0_0_50px_rgba(255,215,0,0.05)]">
...
//         <p className="text-gray-400 text-lg leading-relaxed max-w-4xl mb-12">
//           Sustainability is integrated into our approach to development.
//           We actively encourage eco-conscious living through green spaces,
//           solar-powered common areas, efficient planning, and future-ready infrastructure.
//         </p>

//         <div className="grid md:grid-cols-3 gap-8">

//           <div className="bg-black p-8 rounded-3xl border border-yellow-500/10 hover:border-yellow-500/30 transition-all duration-500">
//             <Globe2 className="w-10 h-10 text-yellow-400 mb-5" />
...
//             <p className="text-gray-400 leading-relaxed">
//               Encouraging energy-efficient residential communities
//               through sustainable power solutions.
//             </p>
//           </div>

//           <div className="bg-black p-8 rounded-3xl border border-yellow-500/10 hover:border-yellow-500/30 transition-all duration-500">
//             <Trees className="w-10 h-10 text-yellow-400 mb-5" />
...
//             <p className="text-gray-400 leading-relaxed">
//               Expanding green cover and eco-friendly landscapes
//               around every residential development.
//             </p>
//           </div>

//           <div className="bg-black p-8 rounded-3xl border border-yellow-500/10 hover:border-yellow-500/30 transition-all duration-500">
//             <Building2 className="w-10 h-10 text-yellow-400 mb-5" />
...
//             <p className="text-gray-400 leading-relaxed">
//               Supporting future mobility with EV-ready infrastructure
...
//           Moments of
//           <span className="text-yellow-400"> Giving Back</span>
//         </h2>

//         <p className="text-gray-400 text-lg max-w-3xl mx-auto leading-relaxed">
//           A glimpse into our continuous efforts to support local infrastructure,
//           sponsor cultural events, and contribute meaningfully to the communities around us.
//         </p>
//       </div>
...
//           <p className="text-gray-400 text-lg leading-relaxed mb-6">
//             At RRL Builders & Developers, we believe development is meaningful
//             only when communities grow together. Our initiatives focus on
//             supporting local neighborhoods, improving infrastructure,
//             preserving cultural heritage, and encouraging environmental awareness.
//           </p>
...
//                 <p className="text-gray-400 leading-relaxed">
//                   Supporting local organizations, social initiatives,
//                   and neighborhood welfare activities.
//                 </p>
//               </div>
//             </div>
...
//                 <p className="text-gray-400 leading-relaxed">
//                   Organizing health camps, educational support activities,
//                   and awareness initiatives for local communities.
//                 </p>
//               </div>
//             </div>
...
//                 <p className="text-gray-400 leading-relaxed">
//                   Contributing to temple renovations and cultural programs
//                   that preserve local identity and traditions.
//                 </p>
//               </div>
//             </div>
//           </div>
...
//         <div className="relative h-[550px] rounded-[40px] overflow-hidden border border-yellow-500/20 shadow-[0_0_50px_rgba(255,215,0,0.08)] group">
//           <Image
...
//             <span className="bg-yellow-400 text-black px-4 py-2 rounded-full text-xs uppercase tracking-[0.2em] font-bold inline-block mb-4">
//               Community Initiative
//             </span>

//             <h4 className="text-3xl font-bold max-w-md leading-tight">
...
//       <h2 className="text-4xl md:text-6xl font-bold mt-4 mb-6">
//         Community &
//         <span className="text-yellow-400"> Social Initiatives</span>
//       </h2>

//       <p className="text-gray-400 text-lg max-w-3xl mx-auto leading-relaxed">
//         Capturing moments of appreciation, community support,
//         sports engagement, and social responsibility initiatives
//         led by RRL Builders & Developers.
//       </p>
//     </div>
...
//       {/* IMAGE 1 */}
//       <div className="group">
//         <div className="relative h-[350px] overflow-hidden rounded-[30px] border border-yellow-500/10">
//           <Image
//             src="https://ik.imagekit.io/j0xzq9pns/rrl%20csr/WhatsApp%20Image%202026-05-13%20at%2012.19.14%20PM.jpeg"
//             alt="Certificate Presentation to Police Officers"
//             fill
...
//             <span className="bg-yellow-400 text-black text-xs font-bold px-4 py-2 rounded-full uppercase tracking-wider inline-block mb-4">
//               Community Recognition
//             </span>

//             <h3 className="text-2xl font-bold text-white leading-snug">
//               Certificate Presentation to Police Officers
//             </h3>
//           </div>
//         </div>
//       </div>
...
//         <div className="relative h-[350px] overflow-hidden rounded-[30px] border border-yellow-500/10">
//           <Image
//             src="https://ik.imagekit.io/j0xzq9pns/rrl%20csr/WhatsApp%20Image%202026-05-13%20at%2012.19.15%20PM%20(1).jpeg"
//             alt="Helmet Distribution Initiative"
//             fill
//             className="object-cover group-hover:scale-110 transition-transform duration-700"
//           />
...
//             <h3 className="text-2xl font-bold text-white leading-snug">
//               Helmet Distribution Program for Traffic Safety Awareness
//             </h3>
//           </div>
//         </div>
//       </div>
...
//         <div className="relative h-[350px] overflow-hidden rounded-[30px] border border-yellow-500/10">
//           <Image
//             src="https://ik.imagekit.io/j0xzq9pns/rrl%20csr/WhatsApp%20Image%202026-05-13%20at%2012.19.16%20PM.jpeg"
//             alt="Jacket Support Initiative"
//             fill
//             className="object-cover group-hover:scale-110 transition-transform duration-700"
//           />
...
//             <h3 className="text-2xl font-bold text-white leading-snug">
//               Protective Jacket Distribution for Public Service Officers
//             </h3>
//           </div>
//         </div>
//       </div>
...
//         <div className="relative h-[350px] overflow-hidden rounded-[30px] border border-yellow-500/10">
//           <Image
//             src="https://ik.imagekit.io/j0xzq9pns/rrl%20csr/WhatsApp%20Image%202026-05-13%20at%2012.19.17%20PM%20(1).jpeg"
//             alt="Sports Opening Ceremony"
//             fill
//             className="object-cover group-hover:scale-110 transition-transform duration-700"
//           />
...
//             <h3 className="text-2xl font-bold text-white leading-snug">
//               Community Cricket Tournament Opening Ceremony
//             </h3>
//           </div>
//         </div>
//       </div>
...
//         <div className="relative h-[350px] overflow-hidden rounded-[30px] border border-yellow-500/10">
//           <Image
//             src="https://ik.imagekit.io/j0xzq9pns/rrl%20csr/WhatsApp%20Image%202026-05-13%20at%2012.19.17%20PM%20(2).jpeg"
...
//             <h3 className="text-2xl font-bold text-white leading-snug">
//               Supporting Local Sports & Community Participation
//             </h3>
//           </div>
//         </div>
//       </div> */}
...
//         <div className="relative h-[350px] overflow-hidden rounded-[30px] border border-yellow-500/10">
//           <Image
//             src="https://ik.imagekit.io/j0xzq9pns/rrl%20csr/WhatsApp%20Image%202026-05-13%20at%2012.19.18%20PM.jpeg"
//             alt="CSR Sports Initiative"
//             fill
//             className="object-cover group-hover:scale-110 transition-transform duration-700"
//           />
...
//             <h3 className="text-2xl font-bold text-white leading-snug">
//               Encouraging Team Spirit Through Community Sports Programs
//             </h3>
//           </div>
//         </div>
//       </div>
...
//   <div className="relative h-[350px] overflow-hidden rounded-[30px] border border-yellow-500/10">
//     <Image
//       src="https://ik.imagekit.io/j0xzq9pns/rrl%20csr/WhatsApp%20Image%202026-05-13%20at%2012.21.02%20PM%20(1).jpeg"
//       alt="Community Leadership Recognition"
//       fill
//       className="object-cover group-hover:scale-110 transition-transform duration-700"
//     />
...
//       <h3 className="text-2xl font-bold text-white leading-snug">
//         Community Leadership Recognition & Civic Appreciation Initiative
//       </h3>
//     </div>
//   </div>
// </div>
...
//           <div
//             key={index}
//             className="bg-white/[0.03] backdrop-blur-xl p-10 rounded-[30px] border border-yellow-500/10 text-center hover:border-yellow-500/30 hover:-translate-y-2 transition-all duration-500"
//           >
//             <stat.icon className="w-12 h-12 text-yellow-400 mx-auto mb-6" />

//             <h3 className="text-5xl font-bold mb-4 text-white">
//               {stat.value}
//             </h3>

//             <p className="text-gray-400 uppercase tracking-wider text-sm leading-relaxed">
//               {stat.label}
//             </p>
//           </div>
//         ))}
...
//         <p className="text-4xl md:text-6xl font-bold leading-relaxed text-white">
//           “The true measure of development is not just the spaces we create,
//           but the communities we uplift.”
//         </p>

//         <div className="w-28 h-[2px] bg-yellow-400 mx-auto my-10" />
...
//   {/* CTA */}
//   <section className="py-28 bg-yellow-400 text-black text-center relative overflow-hidden">

//     <div className="absolute inset-0 opacity-10">
//       <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,black,transparent_70%)]" />
//     </div>
...
//       <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-12 leading-relaxed font-medium opacity-90">
//         Join us in creating spaces that not only shelter families,
//         but also nurture stronger, greener, and more connected communities.
//       </p>

//       <a
//         href="/contact"
//         className="inline-flex items-center justify-center bg-black text-white px-10 py-5 rounded-full font-semibold text-lg hover:bg-neutral-900 transition-all duration-300 hover:scale-105"
//       >
//         Contact Us Today
//       </a>
//     </div>
  ...
  return (
    <div className="bg-black min-h-screen text-white overflow-hidden">
      ...
      <section className="py-24 bg-neutral-950 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-20">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold mt-4 mb-8">
              Creating Meaningful
              <span className="text-yellow-400"> Social Impact</span>
            </h2>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold mt-5 mb-8 leading-tight">
                Building Responsible
                <span className="text-yellow-400"> Urban Communities</span>
              </h2>
            ...
            <div className="relative h-[400px] md:h-[600px] rounded-[40px] overflow-hidden border border-yellow-500/20 shadow-[0_0_50px_rgba(255,215,0,0.08)]">
              <Image
                src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=1200&auto=format&fit=crop"
                alt="Sustainable Building"
                fill
      ...
      <section className="py-28 bg-black">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative h-[400px] md:h-[550px] rounded-[40px] overflow-hidden border border-yellow-500/20 shadow-[0_0_50px_rgba(255,215,0,0.08)] group">
              <Image
                src="https://images.unsplash.com/photo-1529156069898-49953e39b3ac?q=80&w=1200&auto=format&fit=crop"
                alt="CSR Activities"
                fill
      ...
      <section className="py-24 bg-neutral-950 border-y border-yellow-500/10">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto text-center">
            <p className="text-2xl md:text-4xl lg:text-6xl font-bold leading-relaxed text-white">
              “The true measure of development is not just the spaces we create,
              but the communities we uplift.”
            </p>
