...
//     <div 
//       className={cn(
//         "flex items-center gap-3 p-2 bg-black/90 backdrop-blur-md rounded-2xl border border-gray-800 shadow-2xl transition-all",
//         isMobile ? "w-full justify-between" : "w-fit"
//       )}
//     >
      
//       {/* 1. BOOK A VISIT BUTTON */}
//       <Dialog open={open} onOpenChange={setOpen}>
//         <DialogTrigger asChild>
//           <Button
//             className={cn(
//               "bg-white text-black hover:bg-gray-200 rounded-full font-bold flex items-center gap-2 transition-all shadow-md text-base",
...
//       <Button
//         variant="outline"
//         className="rounded-full w-12 h-12 p-0 bg-white border-none hover:bg-gray-200 text-black shadow-md shrink-0"
...
//       <Button
//         variant="outline"
//         className="rounded-full w-12 h-12 p-0 bg-white border-none hover:bg-gray-200 text-[#25D366] shadow-md shrink-0"
...
//           <div className="hidden lg:block">
//             {/* REPLACED BrochureDownloadForm with SiteVisitAction */}
//             <SiteVisitAction />
//           </div>
