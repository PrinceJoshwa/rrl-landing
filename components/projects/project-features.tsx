...
//             <div
//               key={index}
//               className="bg-black rounded-2xl p-8 shadow-md hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 flex flex-col items-center text-center"
//             >
