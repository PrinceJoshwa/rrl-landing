...
// ===================================================
// nri-inquiry-api.php
// Paramantra CRM endpoint for "NRI Inquiry Form"
// Used by: app/nri-corner/page.tsx
// ===================================================
...
$input = [
    ...
    'count_11109'  => $body['country'] ?? 'India',  // Country field (NRI-specific)
    'alert_client' => 0,
    'alert_rep'    => 0,
];

$url      = 'https://cloud.paramantra.com/paramantra/api/data/new/format/json';
$api_key  = 'F1CxM6ux5A245GoE5qKs2t6K35';
$app_name = '16F24';
