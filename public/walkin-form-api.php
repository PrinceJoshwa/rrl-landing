...
// ===================================================
// walkin-form-api.php
// Paramantra CRM endpoint for "Walk-in Form"
// Used by: app/walkin-form/page.tsx
// ===================================================
...
$input = [
    ...
    'channel_id'   => 'Walk-in Form',
    'subject'      => 'Lead from Website',
    'f_name'       => $fName,
    'l_name'       => $lName,
    'email'        => $body['email']    ?? '',
    'phonefax'     => $body['phone']    ?? '',
    'notes'        => $body['remarks']  ?? 'Walk-in enquiry from website',
    'project'      => $body['project']  ?? 'RRL Palacio',
    'location'     => $body['location'] ?? '',       // Walk-in visitor's city/area
    'sourc_11622'  => $body['source']   ?? 'Website', // Source of lead
    'alert_client' => 0,
    'alert_rep'    => 0,
];

$url      = 'https://cloud.paramantra.com/paramantra/api/data/new/format/json';
$api_key  = 'uyGwCLtxv1qrMD1EqCCw5CHyqt';
$app_name = '16F24';
